...
class Router {
    ...
    private string $controllersPath = 'App';
    ...
    final protected function getRouter() : Controller {
        ...
        do {
            ...
            $classLoad  = "\\{$this->controllersPath}\\{$ctrl}\\Controller";
    ...
    final protected function sistemRouter() : Controller{
        ...
        while ( count($urlExplode) ){
            ...
            if ( class_exists("\\{$this->controllersPath}\\{$auxController}\\Controller") ){
        ...
        if ( is_null($controller) ) {
            if ( class_exists("\\{$this->controllersPath}\\index\\Controller") ){
                $controller = "index";
            } else {
        ...
        //--Instancia Controller
        $classLoad  = "\\{$this->controllersPath}\\{$controller}\\Controller";
        $Controller = new $classLoad();

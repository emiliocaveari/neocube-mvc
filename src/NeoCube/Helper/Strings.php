...
class Strings {
    ...
    static public function toCamelCase(string $string , string|array $separator='_') : string {
        $camelCase = str_replace(' ', '', ucwords(str_replace($separator, ' ', strtolower($string))));
        $camelCase[0] = strtolower($camelCase[0]);
        return $camelCase;
    }

    static public function reverseCamelCase(string $str, string $separator='_') : string {
